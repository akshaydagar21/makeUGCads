  ...
  return (
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
        ...
        <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
            ...
            <Title heading="Create In-Context Image"
            ...
            <div className="flex gap-20 max-sm:flex-col items-start justify-between">
                ...
                <div className="w-full">
                    <div className="mb-4 text-gray-300">
                        ...
                        placeholder="Name your project" required className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm 
                    ...
                    <div className="mb-4 text-gray-300">
                        ...
                        placeholder="Enter the name of your product" required className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm 
                        border-violet-200/10 focus:border-violet-500/50 outline-none transition-all" />
                    </div>
                    <div className="mb-4 text-gray-300">
                    ...
                    <div className="mb-4 text-gray-300">
                        ...
                        placeholder="Describe how you want the narration to be." className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
                        />
                    </div>
